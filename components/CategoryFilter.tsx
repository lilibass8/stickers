...
const categories = ['الكل', 'أوراق ستيكرات', 'ستيكرات مفردة', 'اقتباسات عربية', 'مجموعة كيوت']
    ...
    <div className="mb-8 flex flex-wrap gap-3">
      {categories.map((category) => (
        <button
          ...
          className={`rounded-2xl px-6 py-2 font-medium transition-all duration-200 ${selectedCategory === category
